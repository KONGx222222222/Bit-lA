do local gui = game:GetService("CoreGui"):FindFirstChild("HovxrzGui") if gui then gui:Destroy() end end
...
local Library = library:CreateWindow("Bit",Color3.fromRGB(0,255,0),"Happy Happy")
local General = Library:AddTab("General")
General:AddSeperator("General")
General:AddButton("1 Click Happy Ez Win",function() -- Cant use with Snow
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-235.12912, 194.49794, 299.768768, 0.776710987, 2.72649636e-08, -0.629857123, 9.88283055e-09, 1, 5.54745903e-08, 0.629857123, -4.93124972e-08, 0.776710987)
end)
General:AddButton("1 Click Happy Pik Pi Ti Kao",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(33.0005608, 72.7980042, 45.8850136, 0.96280551, -2.46896175e-08, -0.270195335, 1.33093252e-08, 1, -4.39508874e-08, 0.270195335, 3.87200387e-08, 0.96280551)
end)
General:AddSeperator("Happy function")
General:AddButton("Happy Health",function()
game:GetService("Workspace").testSc248.Humanoid.MaxHealth = 1000000
game:GetService("Workspace").testSc248.Humanoid.Health = 1000000
end)
